...
namespace PopVuj.Scripting
{
    ...
    public class PopVujEditorExtension : IEditorExtension
    {
        ...
        public List<EditorFuncInfo> GetAvailableFunctions() => new()
        {
            ...
            new EditorFuncInfo { Name = "get_sewer_pop",   Hint = "sewer den slot count (derived)",ArgCount = 0 },
            ...
            new EditorFuncInfo { Name = "get_sewer_cell",  Hint = "sewer archetype at slot (0-6)", ArgCount = 1 },
